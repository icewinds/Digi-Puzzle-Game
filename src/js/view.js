...
export default class View {
  ...
  bindSelectPieceToMove ( handler ) {
	...
	renderPiece ( index, baseNumber, pieceSize ) {
		...
		pieceEl.style.backgroundImage = `url(assets/digi.png)`;
		pieceEl.style.backgroundSize = `${baseNumber*100}%`;
		pieceEl.style.backgroundPositionX = `${coordinateX*380}px`;
		pieceEl.style.backgroundPositionY = `${coordinateY*380}px`;
